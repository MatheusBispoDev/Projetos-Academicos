...
public class frmCadFuncionarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comboCargo = new javax.swing.JTextField();
        ...
        lblUsuário.setText("Cadastrar Funcionário");
        ...
        jLabel11.setText("Código da Empresa:");
        ...
        tblCon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "RG", "Empresa", "Nome", "Telefone", "Endereço", "Numero", "CEP", "Foto", "Cargo"
            }
        ));
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        if("".equals(txtRG.getText())||"".equals(txtNome.getText())||"".equals(txtEmpresa.getSelectedItem())|| lblImg.getIcon()==null){
            ...
            em = (Empresa) txtEmpresa.getSelectedItem();
            
            f.setRg(txtRG.getText());
            f.setEmpresa(em.getCodigo());
            f.setNome(txtNome.getText());
            f.setTelefone(txtTelefone.getText());
            f.setEndereco(txtEndereco.getText());
            f.setNum(Integer.parseInt(txtNumero.getText()));
            f.setCep(txtCEP.getText());
            f.setCargo(String.valueOf(comboCargo.getText()));
            f.setImg(txtImg.getText());
            dao.create(f);
    ...
    private void tblConMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblConMouseClicked
        if (tblCon.getSelectedRow() != -1) {
            ...
            txtEmpresa.setSelectedItem(tblCon.getValueAt(tblCon.getSelectedRow(), 1).toString());
            txtNome.setText(tblCon.getValueAt(tblCon.getSelectedRow(), 2).toString());
            txtTelefone.setText(tblCon.getValueAt(tblCon.getSelectedRow(), 3).toString());
            txtEndereco.setText(tblCon.getValueAt(tblCon.getSelectedRow(), 4).toString());
            txtNumero.setText(tblCon.getValueAt(tblCon.getSelectedRow(), 5).toString());
            txtCEP.setText(tblCon.getValueAt(tblCon.getSelectedRow(), 6).toString());
            txtImg.setText(tblCon.getValueAt(tblCon.getSelectedRow(), 7).toString());
            comboCargo.setText(tblCon.getValueAt(tblCon.getSelectedRow(), 8).toString());
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        if("".equals(txtNome.getText())||"".equals(txtEmpresa.getSelectedItem())){
            JOptionPane.showMessageDialog(null, "Preencha todos os campos", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
        else{
            Funcionario f = new Funcionario();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        f.setRg((String) tblCon.getValueAt(tblCon.getSelectedRow(), 0));
   ...
   private void readJTable() {
    ...
    private javax.swing.JTextField comboCargo;
